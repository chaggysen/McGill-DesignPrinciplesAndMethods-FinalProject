 ...
 * like constants and hardware. <br>
 * <br>
...
public class Resources {
  ...
  public static final double BASE_WIDTH = 0.1621;
  
  /** The robot bumper protrusion in feet. */
  public static final double BUMPER_OFFSET = 0.4921259843; // 0.15 in meters
  
  /** The distance between the color sensors and the wheels in feet. */
  public static final double COLOR_SENSOR_TO_WHEEL_DIST = 0.12007874; // 0.0366 in meters
  ...
  /** The speed at which the robot rotates in degrees per second. */
  public static final int ARM_SPEED = 300;
  ...
  /** The top motor. */
  public static final RegulatedMotor armMotor = Motor.B;
  
  /** The lower ultrasonic sensor. */
  public static final EV3UltrasonicSensor LowUsSensor = new EV3UltrasonicSensor(SensorPort.S1);
  
  /** The higher ultrasonic sensor. */
  public static final EV3UltrasonicSensor obstacleUSSensor = new EV3UltrasonicSensor(SensorPort.S4);
  ...
  /** The avoidance. */
  public static Avoidance avoider = Avoidance.getAvoidance();
  ...
  /** Team color. */
  public static String teamColor = setMaParam();
  
  /** Team's starting corner. */
  public static int corner;
  
  /** The edge when facing the team ramp. */
  public static RampEdge ramp;

  /** The Team Zone. */
  public static Region teamZone;
  
  /** The Island. */
  public static Region island = makeRegion("Island");
  
  /** The team tunnel footprint. */
  public static Region tunnel;
  
  /** The team search zone. */
  ...
  /**
   * Initializes the Wi-Fi variables in resources with the parameters relevant to the team's color.
   * 
   * @return The team color as a String
   */
  public static String setMaParam() {
    if (TEAM_NUMBER == getWP("RedTeam")) {
      corner = getWP("RedCorner");
      ramp = makeRampEdge("RR");
      teamZone = makeRegion("Red");
      tunnel = makeRegion("TNR");
      searchZone = makeRegion("SZR");
      return "Red";
    } else if (TEAM_NUMBER == getWP("GreenTeam")) {
      corner = getWP("GreenCorner");
      ramp = makeRampEdge("GR");
      teamZone = makeRegion("Green");
      tunnel = makeRegion("TNG");
      searchZone = makeRegion("SZG");
      return "Green";
    }
    return null;
  }
